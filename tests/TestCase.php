...
namespace Parfumux\Laraplans\Tests;
...
class TestCase extends Testbench
{
    ...
    protected function getEnvironmentSetUp($app)
    {
        ...
        // Set user model
        $app['config']->set('auth.providers.users.model', '\Parfumux\Laraplans\Tests\Models\User');
    ...
    {
        return ['Parfumux\Laraplans\LaraplansServiceProvider'];
    }
